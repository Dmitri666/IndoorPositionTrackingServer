...
{
    public class KitchenInternationalTypeMapper : EntityTypeConfiguration<KitchenInternationalType>
    {
        public KitchenInternationalTypeMapper()
        {
            //Key
            this.HasKey(c => c.Id);
            ...
            //table  
            this.ToTable("dbo.KitchenInternationalType");                       
        }
    }
}
